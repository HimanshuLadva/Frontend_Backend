      ...
      <div class="main-header d-none d-lg-block">
        ...
        <div class="bg-primary header-top">
          <div class="text-center text-white welcome-message">
            <p class="text-white">Welcome to Corano Jewellery online store</p>
          </div>
        </div>
        <!-- header top end -->
                  ...
                  <div class="header-configure-area">
                    <ul class="nav justify-content-end">
                      <li class="header-search-container mr-0">
                        ...
                        <form
                          class="header-search-box d-none animated jackInTheBox"
                        >
                          <input
                            type="text"
                    ...
                    <nav class="desktop-menu">
                      <ul class="justify-content-center header-style-4">
                        ...
                        <li class="position-static">
                          ...
                          <ul class="megamenu dropdown w_100_vw left_75">
                            <li class="mega-title">
                              <span>column 01</span>
                              <ul>
                                <li>
                            ...
                            <li class="megamenu-banners d-none d-lg-block">
                              <a href="product-details.html">
                                <img
                                  src="assets/img/banner/img1-static-menu.jpg"
                                  alt=""
                                />
                              </a>
                            </li>
                            <li class="megamenu-banners d-none d-lg-block">
                              <a href="product-details.html">
                                <img
                                  src="assets/img/banner/img2-static-menu.jpg"
                                  alt=""
                                />
                              </a>
                            </li>
                              ...
                              <ul class="dropdown">
                                ...
                                <li>
                                  <a href="shop-grid-full-3-col.html"
                                    >shop grid full 3 col</a
                                  >
                                </li>
                                <li>
                                  <a href="shop-grid-full-4-col.html"
                                    >shop grid full 4 col</a
                                  >
                                </li>
                              </ul>
                            </li>
              ...
              <div class="header-right d-flex align-items-center justify-content-xl-between justify-content-lg-end">
                                <div class="header-search-container">
                                   ...
                                   <form class="header-search-box d-lg-none d-xl-block animated jackInTheBox">
                                        <input type="text" placeholder="Search entire store hire" class="bg-primary header-search-field py-1 text-right text-white input_placeholder_color_fff">
                                        <button class="header-search-btn"><i class="pe-7s-search text-white"></i></button>
                                    </form>
                                </div>
                                <div class="header-configure-area">
                                    <ul class="nav justify-content-end">
        ...
        <div class="off-canvas-inner-content">
          ...
          <div class="off-canvas-inner">
            ...
            <div class="search-box-offcanvas">
              <form>
                <input type="text" placeholder="Search Here..." class="bg-primary text-white input_placeholder_color_fff">
                <button class="search-btn"><i class="pe-7s-search text-white"></i></button>
              </form>
            </div>
            <!-- search box end -->
                ...
                <ul class="mobile-menu">
                  ...
                  <li class="menu-item-has-children"><span class="menu-expand"><i></i></span>
                    ...
                    <ul class="megamenu dropdown" style="display: none;">
                      <li class="mega-title menu-item-has-children"><span class="menu-expand"><i></i></span>
                        <a href="#">column 01</a>
                        <ul class="dropdown" style="display: none;">
                          <li>
                            <a href="shop.html">shop grid left sidebar</a>
            ...
            <div class="d-none mobile-settings">
              <ul class="nav">
                <li>
                  <div class="dropdown mobile-top-dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="currency" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(72px, 20px, 0px);" x-out-of-boundaries="">
                ...
                <li>
                  <div class="dropdown mobile-top-dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="myaccount" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(89px, 20px, 0px);" x-out-of-boundaries="">
