$(function () {
  ...
  $(i).submit(function (e) {
    e.preventDefault();
    var t = $(i).serialize();
    $.ajax({ type: "POST", url: $(i).attr("action"), data: t })
      .done(function (e) {
        $(s).removeClass("error"),
          $(s).addClass("success"),
          $(s).text(e),
        ...
        return (
          d(this).each(function (e, t) {
            var o = d(t),
              ...
              a = d.extend({ url: o.attr("action"), language: "en" }, i),
              ...
              o.submit(function () {
                ...
                d.each(e, function (e, t) {
                  ...
                  d.ajax({
                    ...
                    success: function (t) {
                      ...
                      "en" !== a.language &&
                        void 0 !== d.ajaxChimp.responses[s] &&
                        d.ajaxChimp.translations &&
                        d.ajaxChimp.translations[a.language] &&
                        d.ajaxChimp.translations[a.language][
                          d.ajaxChimp.responses[s]
                        ] &&
                        (s =
                          d.ajaxChimp.translations[a.language][
                            d.ajaxChimp.responses[s]
                ...
                return (
                  "en" !== a.language &&
                    d.ajaxChimp.translations &&
                    d.ajaxChimp.translations[a.language] &&
                    d.ajaxChimp.translations[a.language].submit &&
                    (t = d.ajaxChimp.translations[a.language].submit),
                  r.html(t).show(2e3),
                  !1
                );
              });
              ...
              null !== f &&
                ("!" === h &&
                  ...
                  (t = p) &&
                    ...
                    (s = 1 === t.length ? t[0] : ((o = t[0]), t[1]))),
                  (f = 1 < Math.abs(i) ? s : o)),
                "" === h && f < 10 && (f = "0" + f.toString()),
                (e = e.replace(u, f.toString())));
          }
        return e.replace(/%%/, "%");
      };
    }
...
function initialize() {
  var e = {
    ...
    i = new google.maps.Marker({ position: myCenter, map: t });
  t.setOptions({
    styles: [
      {
      ...
      (f.fn.zoom = function (i) {
        return this.each(function () {
          ...
          if (!o.url) {
            ...
            if (
              (t &&
                (o.url = t.getAttribute("data-src") || t.currentSrc || t.src),
              !o.url)
            )
              return;
          }
          r.one(
            ...
            (a.onload = function () {
              ...
              var s = f.zoom(n, e, a, o.magnify);
              "grab" === o.on
                ? r.on("mousedown.zoom", function (e) {
                    1 === e.which &&
                      (f(document).one("mouseup.zoom", function () {
                        i(), f(document).off(d, s.move);
                      }),
                      t(e),
                      f(document).on(d, s.move),
                      e.preventDefault());
                  })
                : "click" === o.on
  ...
  function () {
    ...
    function s(e, t) {
      ...
      if (
        ...
        for (i in e) (s = e[i]), (this.options[i] = s);
    ...
    (s.prototype.hasNext = function () {
      ...
      (s.prototype.run = function (e) {
        ...
        return (
          ...
          "undefined" != typeof document &&
            ...
            (window[t] = new s(this.options, this)),
      ...
      (s.prototype.parse = function (e) {
        ...
        if (
          ...
          switch (
            ...
            case "random":
              ...
              break;
            case "recent":
              e.data = this._sortBy(e.data, "created_time", _);
              break;
            case "liked":
              e.data = this._sortBy(e.data, "likes.count", _);
              break;
            case "commented":
              e.data = this._sortBy(e.data, "comments.count", _);
              break;
            default:
              throw new Error(
        ...
        if (
          ...
          if (
            ...
            for (
              a = "", E = document.createElement("div"), l = 0, k = h.length;
              l < k;
              l++
            ) {
              if (
            ...
            for (
              E.innerHTML = a, o = [], s = 0, i = E.childNodes.length;
              s < i;

            )
              o.push(E.childNodes[s]), (s += 1);
            for (y = 0, b = o.length; y < b; y++) (T = o[y]), r.appendChild(T);
          } else
            for (w = 0, S = h.length; w < S; w++) {
              if (
                ((d = h[w]),
              ...
              (u = c.url),
                ...
                !0 === this.options.links
                  ? (((t = document.createElement("a")).href = d.link),
                    t.appendChild(p),
                    r.appendChild(t))
                  : r.appendChild(p);
            }
          if (
            ("string" == typeof ($ = this.options.target) &&
      ...
      (s.prototype._buildUrl = function () {
        var e, t;
        ...
        return (
          ...
          null != this.options.accessToken
            ? (t += "?access_token=" + this.options.accessToken)
            : (t += "?client_id=" + this.options.clientId),
          null != this.options.limit && (t += "&count=" + this.options.limit),
          (t += "&callback=instafeedCache" + this.unique + ".parse")
        );
      }),
      (s.prototype._genKey = function () {
        var e;
        return (
          "" +
          (e = function () {
      ...
      (s.prototype._makeTemplate = function (e, t) {
        var i, s, o, n, r;
        for (s = /(?:\{{2})([\w\[\]\.]+)(?:\}{2})/, i = e; s.test(i); )
          (n = i.match(s)[1]),
            (r = null != (o = this._getObjectProperty(t, n)) ? o : ""),
            (i = i.replace(s, function () {
              return "" + r;
            }));
        return i;
      }),
      (s.prototype._getObjectProperty = function (e, t) {
        var i, s;
      ...
      (s.prototype._sortBy = function (e, o, n) {
        var t;
        return (
          (t = function (e, t) {
            var i, s;
            return (
              (i = this._getObjectProperty(e, o)),
              (s = this._getObjectProperty(t, o)),
              n ? (s < i ? 1 : -1) : i < s ? 1 : -1
            );
          }),
          e.sort(t.bind(this)),
    ...
    (c.cleanData =
      ...
      (c.widget = function (e, i, t) {
        ...
        return (
          ...
          s
            ? (c.each(s._childConstructors, function (e, t) {
                var i = t.prototype;
      ...
      (c.widget.extend = function (e) {
        for (
          var t, i, s = a.call(arguments, 1), o = 0, n = s.length;
          o < n;
          o++
        )
          for (t in s[o])
            (i = s[o][t]),
              s[o].hasOwnProperty(t) &&
                void 0 !== i &&
                (e[t] = c.isPlainObject(i)
                  ? c.isPlainObject(e[t])
      ...
      (c.Widget.prototype = {
        ...
        option: function (e, t) {
          ...
          if ("string" == typeof e)
            if (((n = {}), (e = (i = e.split(".")).shift()), i.length)) {
              for (
                s = n[e] = c.widget.extend({}, this.options[e]), o = 0;
                i.length - 1 > o;
                o++
              )
                (s[i[o]] = s[i[o]] || {}), (s = s[i[o]]);
        ...
        _classes: function (o) {
          function e(e, t) {
            ...
            for (s = 0; e.length > s; s++)
              (i = r.classesElementLookup[e[s]] || c()),
                (i = o.add
                  ? c(c.unique(i.get().concat(o.element.get())))
                  : c(i.not(o.element).get())),
                (r.classesElementLookup[e[s]] = i),
                n.push(e[s]),
                t && o.classes[e[s]] && n.push(o.classes[e[s]]);
          }
          var n = [],
            r = this;
          return (
        ...
        _untrackClassesElement: function (i) {
          ...
          c.each(s.classesElementLookup, function (e, t) {
            -1 !== c.inArray(i.target, t) &&
              (s.classesElementLookup[e] = c(t.not(i.target).get()));
          });
        },
            ...
            c.each(e, function (e, t) {
              function i() {
                return r ||
                  ...
                  ? ("string" == typeof t ? d[t] : t).apply(d, arguments)
                  : void 0;
              }
              "string" != typeof t &&
        ...
        _trigger: function (e, t, i) {
          ...
          return (
            ...
            !(
              (c.isFunction(n) &&
                !1 === n.apply(this.element[0], [t].concat(i))) ||
      ...
      c.each({ show: "fadeIn", hide: "fadeOut" }, function (n, r) {
        c.Widget.prototype["_" + n] = function (t, e, i) {
          ...
          var s,
            o = e ? (!0 === e || "number" == typeof e ? r : e.effect || r) : n;
          "number" == typeof (e = e || {}) && (e = { duration: e }),
            (s = !c.isEmptyObject(e)),
            (e.complete = i),
            e.delay && t.delay(e.delay),
            s && c.effects && c.effects.effect[o]
              ? t[n](e)
              : o !== n && t[o]
    ...
    c(document).on("mouseup", function () {
        ...
        _mouseInit: function () {
          ...
          this.element
            ...
            .on("click." + this.widgetName, function (e) {
              return !0 ===
                c.data(e.target, t.widgetName + ".preventClickEvent")
      ...
      c.widget("ui.slider", c.ui.mouse, {
        ...
        _createHandles: function () {
          ...
          (this.handles = s.add(c(o.join("")).appendTo(this.element))),
            this._addClass(
              this.handles,
              "ui-slider-handle",
              "ui-state-default"
        ...
        _mouseCapture: function (e) {
          ...
          return (
            ...
            !1 !== this._start(e, n) &&
              ...
              o.trigger("focus"),
              (r = o.offset()),
              (a = !c(e.target).parents().addBack().is(".ui-slider-handle")),
              (this._clickOffset = a
                ? { left: 0, top: 0 }
                : {
        ...
        values: function (e, t) {
          ...
          for (i = this.options.values, s = e, o = 0; i.length > o; o += 1)
          ...
          this._hasMultipleValues()
            ? this.handles.each(function (e) {
                (i =
                  ...
                  (d["horizontal" === a.orientation ? "left" : "bottom"] =
                    i + "%"),
                  c(this).stop(1, 1)[l ? "animate" : "css"](d, r.animate),
                  !0 === a.options.range &&
            ...
            : ((e = this.value()),
              ...
              (d["horizontal" === this.orientation ? "left" : "bottom"] =
                i + "%"),
              this.handle.stop(1, 1)[l ? "animate" : "css"](d, r.animate),
              "min" === n &&
                "horizontal" === this.orientation &&
                this.range
                  .stop(1, 1)
        ...
        _handleEvents: {
          keydown: function (e) {
            var t,
              i,
              s,
              o = c(e.target).data("ui-slider-handle-index");
            switch (e.keyCode) {
  ...
  (function (n) {
    n.fn.niceSelect = function (e) {
      ...
      this.hide(),
        ...
        n(document).on("click.nice_select", ".nice-select", function (e) {
          var t = n(this);
        ...
        n(document).on("click.nice_select", function (e) {
          0 === n(e.target).closest(".nice-select").length &&
      ...
      return (
        ...
        "auto" !== t.pointerEvents && n("html").addClass("no-csspointerevents"),
        this
      );
    };
  })(jQuery),
      ...
      (r.prototype.checkResponsive = function (e, t) {
        ...
        if (
          ("window" === n.respondTo
            ...
            : "slider" === n.respondTo
            ? (o = a)
            : "min" === n.respondTo && (o = Math.min(l, a)),
        ...
        switch (
          ...
          case "index":
            var r =
              0 === e.data.index
                ? 0
                : e.data.index || n.index() * o.options.slidesToScroll;
          ...
          !0 === r.options.swipeToSlide
            ? (r.$slideTrack.find(".slick-slide").each(function (e, t) {
                ...
                if (
                  ((i = d(t).outerWidth()),
                  (s = t.offsetLeft),
                  !0 !== r.options.centerMode && (s += i / 2),
                  n < s + i)
                )
                  return (o = t), !1;
              }),
              Math.abs(d(o).attr("data-slick-index") - r.currentSlide) || 1)
        ...
        if (
          (!0 === n.options.centerMode
            ...
            : ((i = n.options.infinite
              ...
              !0 === n.options.fade &&
                (0 < i && i--, s <= n.slideCount && s++)),
          (t = n.$slider.find(".slick-slide").slice(i, s)),
          "anticipated" === n.options.lazyLoad)
        )
          for (
            var o = i - 1, r = s, a = n.$slider.find(".slick-slide"), l = 0;
            ...
            for (t in s)
              if ("array" !== d.type(n.options.responsive))
                ...
                for (e = n.options.responsive.length - 1; 0 <= e; )
                  n.options.responsive[e].breakpoint === s[t].breakpoint &&
