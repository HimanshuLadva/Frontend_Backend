...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebsiteCMS.DAL.Data.Models.BOTImageOrFile", b =>
                {
                    ...
                    b.HasIndex("BotQuestionId")
                        .IsUnique();

                    b.ToTable("tblBOTImageOrFile");
                });
            ...
            modelBuilder.Entity("WebsiteCMS.DAL.Data.Models.SociaMediaPost", b =>
                {
                    ...
                    b.Property<int?>("FacebookPagesTokensId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FacebookPagesTokensId");
            ...
            modelBuilder.Entity("WebsiteCMS.DAL.Data.Models.BOTImageOrFile", b =>
                {
                    b.HasOne("WebsiteCMS.DAL.Data.Models.BOTQuestion", "BotQuestion")
                        .WithOne("ImageOrFile")
                        .HasForeignKey("WebsiteCMS.DAL.Data.Models.BOTImageOrFile", "BotQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BotQuestion");
                });
            ...
            modelBuilder.Entity("WebsiteCMS.DAL.Data.Models.SociaMediaPost", b =>
                {
                    b.HasOne("WebsiteCMS.DAL.Data.Models.FacebookPagesTokens", null)
                        .WithMany("SociaMediaPosts")
                        .HasForeignKey("FacebookPagesTokensId");
                });
